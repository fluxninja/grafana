...
function transformFnData() {
  return function (_a) {
    var series = _a.series,
        other = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["series"]);
...
var SANKEY_FIELD_NAMES = ['source', 'target', 'value']; // @ts-ignore
...
function mapField() {
  return function (field, _, __) {
    ...
    var isArrayVector = field.values instanceof _grafana_data__WEBPACK_IMPORTED_MODULE_1__["ArrayVector"] || typeof ((_a = field.values) === null || _a === void 0 ? void 0 : _a.toArray) === 'function';
    var isArray = Array.isArray(field.values);

    if (!isSankeyField || !field.values || !isArray && !isArrayVector) {
      return field;
    }

    var values = isArrayVector ? field.values.toArray() : isArray ? field.values : null;

    if (values === null) {
      return field;
    }

    var parsedValues = isSankeyField ? values.map(splitValue())[0].map(mapToNumber()) : null;
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, field), {
      type: (parsedValues === null || parsedValues === void 0 ? void 0 : parsedValues.every(isNumber())) ? _grafana_data__WEBPACK_IMPORTED_MODULE_1__["FieldType"].number : field.type,
      values: parsedValues ? new _grafana_data__WEBPACK_IMPORTED_MODULE_1__["ArrayVector"](parsedValues) : values
    });
  };
} // @ts-ignore
