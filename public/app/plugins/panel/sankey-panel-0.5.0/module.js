    ...
    function (t, e, n) {
      ...
      function M() {
        ...
        function v() {
          ...
          return M(t), T(t), P(t), V(t), C(t), j(t), t;
        }
                  ...
                  fields: t.fields.map(function (t, e, n) {
                    ...
                    return i(i({}, t), {
                      type: (
                        ...
                        ? o.FieldType.number
                        : t.type,
                      values: c ? new o.ArrayVector(c) : l,
                    });
                  }),
                })
              );
      ...
      var lt = ['source', 'target', 'value'];
      n.d(e, 'plugin', function () {
        return ct;
      });
      var ct = new o.PanelPlugin(function (t) {
        var e = t.data,
          n = a(t, ['data']),
          r = Object(u.useMemo)(ut, []),
          o = Object(u.useMemo)(
            function () {
              return r(e);
            },
        ...
        return l.a.createElement(st, i({}, i(i({}, n), { data: o })));
